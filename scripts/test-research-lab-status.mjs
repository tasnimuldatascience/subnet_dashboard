...
try {
  ...
  const cases = [
    ...
    {
      name: 'stale running ticket with terminal loop failure renders Failed',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentQueueStatus: 'failed',
      ...
      expected: {
        ...
        active: false,
        scoring: false,
        detail: 'Final outcome: loop failed terminally.',
      },
    },
    {
      name: 'genuinely running legacy loop remains active',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentCandidateStatus: 'evaluating',
