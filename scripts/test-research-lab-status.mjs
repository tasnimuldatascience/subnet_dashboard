...
try {
  ...
  const cases = [
    ...
    {
      name: 'score bundle current overrides stale running ticket as Scored',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentTicketStatus: 'running',
        currentScoreBundleStatus: 'scored',
        scoreBundleCount: 1,
        currentCandidateStatus: 'failed',
        currentQueueStatus: 'running',
        hasCanonicalCandidateStatus: true,
        hasCanonicalQueueStatus: true,
        candidateCount: 1,
        scoredCandidateCount: 0,
        runId: 'run-score-bundle-overrides-running',
        receiptId: 'receipt-score-bundle-overrides-running',
      },
      expected: {
        key: 'scored_no_gain',
        label: 'Scored',
    ...
    {
      name: 'stale running ticket with scored candidate renders Scored',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        ...
        candidateCount: 1,
        scoredCandidateCount: 1,
        runId: 'run-stale-running-scored',
        receiptId: 'receipt-stale-running-scored',
      },
      expected: {
        key: 'scored_no_gain',
        label: 'Scored',
    ...
    {
      name: 'stale running ticket with failed candidate scoring renders Scoring failed',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentCandidateStatus: 'failed',
        ...
        candidateCount: 1,
        scoredCandidateCount: 0,
        runId: 'run-stale-running-scoring-failed',
        receiptId: 'receipt-stale-running-scoring-failed',
      },
      expected: {
        key: 'scoring_failed',
        label: 'Scoring failed',
    ...
    {
      name: 'stale running ticket with rejected candidate renders Not promoted',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
    ...
    },
    {
      ...
      input: {
        ...
        outcomeBand: 'running',
        currentQueueStatus: 'completed',
        currentQueueReason: 'completed_no_candidate_produced',
        hasCanonicalQueueStatus: true,
        candidateCount: 0,
        scoredCandidateCount: 0,
        runId: 'run-stale-running-no-candidate',
        receiptId: 'receipt-stale-running-no-candidate',
      },
      expected: {
        key: 'completed_no_candidate',
        label: 'No candidate',
        band: 'completed',
        active: false,
        scoring: false,
        detail: 'Final outcome: no valid candidate was produced.',
      },
    },
    {
      name: 'stale running ticket with terminal loop failure renders Run failed',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentLoopStatus: 'failed',
        hasCanonicalLoopStatus: true,
        currentTicketStatus: 'running',
        hasCanonicalTicketStatus: true,
        candidateCount: 0,
        scoredCandidateCount: 0,
        runId: 'run-stale-running-failed',
        receiptId: 'receipt-stale-running-failed',
      },
      expected: {
        key: 'failed',
        label: 'Run failed',
        ...
        active: false,
        scoring: false,
        detail: 'Final outcome: run failed terminally.',
      },
    },
    {
      name: 'completed canonical loop renders Completed',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentLoopStatus: 'completed',
        hasCanonicalLoopStatus: true,
        currentTicketStatus: 'running',
        hasCanonicalTicketStatus: true,
        candidateCount: 1,
        scoredCandidateCount: 0,
        runId: 'run-loop-completed',
        receiptId: 'receipt-loop-completed',
      },
      expected: {
        key: 'completed',
        label: 'Completed',
        ...
        active: false,
        scoring: false,
        detail: 'Final outcome: loop completed.',
      },
    },
    {
      name: 'cancelled canonical loop renders Cancelled',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        ...
        candidateCount: 1,
        scoredCandidateCount: 0,
        runId: 'run-loop-cancelled',
        receiptId: 'receipt-loop-cancelled',
      },
      expected: {
        key: 'cancelled',
        label: 'Cancelled',
        ...
        active: false,
        scoring: false,
        detail: 'Final outcome: loop was cancelled.',
      },
    },
    {
      name: 'stale running ticket without active canonical evidence is not active',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentTicketStatus: 'running',
        ...
        candidateCount: 0,
        scoredCandidateCount: 0,
        runId: 'run-ticket-only-running',
        receiptId: 'receipt-ticket-only-running',
      },
      expected: {
        key: 'submitted',
        label: 'Submitted',
    ...
    {
      name: 'genuinely active canonical candidate remains running',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentCandidateStatus: 'evaluating',
        ...
        candidateCount: 1,
        scoredCandidateCount: 0,
        runId: 'run-genuine-running',
        receiptId: 'receipt-genuine-running',
      },
      expected: {
        key: 'running',
        label: 'Running',
    ...
    {
      name: 'genuinely queued run queue remains running',
      input: {
        outcomeLabel: 'running',
        outcomeBand: 'running',
        currentQueueStatus: 'queued',
        ...
        candidateCount: 0,
        scoredCandidateCount: 0,
        runId: 'run-queue-queued',
        receiptId: 'receipt-queue-queued',
      },
      expected: {
        key: 'running',
        label: 'Running',
