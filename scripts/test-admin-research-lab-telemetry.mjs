...
try {
  ...
  assert.match(adminComponentSource, /onMouseEnter=\{hoverPopover\.openNow\}/)
  assert.match(adminComponentSource, /onMouseLeave=\{hoverPopover\.scheduleClose\}/)
  assert.match(adminComponentSource, /onFocus=\{hoverPopover\.openNow\}/)
